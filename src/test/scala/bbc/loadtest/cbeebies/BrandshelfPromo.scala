...
class BrandshelfPromo extends Simulation {
   ...
   val httpProtocol = http
    ...
    val promoServiceUrl = csv("cbeebies/promo-service-urls.csv").circular

    val scn = scenario("Brandshelf Promo")
      .feed(promoServiceUrl)
